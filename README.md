...
- **图片生成**：gpt-image-2 / gpt-image-2pro / Gemini-3-Pro-Image-Preview
- **视频生成**：sora-2 / sd-2 / sd-2-vip / Kling Omni
- 历史记录持久保存、参考图上传、批量勾选下载
- API Key 本地保存（可选）+ 账户余额实时显示 + 切换账号
- 界面字体大小、亮度自定义
...
如有问题，请到 [Issues](https://github.com/maow7275-blip/glacier-ai-release/issues) 反馈或联系开发者。
